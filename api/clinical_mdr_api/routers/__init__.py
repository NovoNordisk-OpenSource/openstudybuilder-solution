...
from clinical_mdr_api.routers.jobs.jobs import router as jobs_router
...
from clinical_mdr_api.routers.meta_study_fields import (
    router as meta_study_fields_router,
)
...
from clinical_mdr_api.routers.standard_data_models.sponsor_model_schemas import (
    router as sponsor_model_schemas_router,
)
