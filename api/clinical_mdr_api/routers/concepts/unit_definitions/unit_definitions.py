...
@router.post(
    "/{unit_definition_uid}/archive",
    dependencies=[security, rbac.LIBRARY_WRITE],
    summary=f"Move unit definition to {settings.archived_library_name} library",
    description="Moves an existing unit definition to the target library if not yet in it. Returns new state of UnitDefinition.",
...
def archive(
    ...
    return service.archive(unit_definition_uid)
