...
# Prefixed with "/odms/vendor-elements"
router = APIRouter()
...
def get_all_odm_vendor_elements(
    ...
    fields: _generic_descriptions.SELECTED_FIELDS = None,
) -> CustomPage[OdmVendorElement]:
    odm_vendor_element_service = OdmVendorElementService()
    results = odm_vendor_element_service.get_all_odms(
...
def get_odm_vendor_element(
    ...
    return odm_vendor_element_service.get_by_uid(
        uid=odm_vendor_element_uid, version=version or None, fields=fields
    )
...
def create_odm_vendor_element(
    ...
    odm_vendor_element_service = OdmVendorElementService()
    return odm_vendor_element_service.create(odm_input=odm_vendor_element_create_input)
...
def edit_odm_vendor_element(
    ...
    return odm_vendor_element_service.edit_draft(
        uid=odm_vendor_element_uid, odm_edit_input=odm_vendor_element_edit_input
    )
