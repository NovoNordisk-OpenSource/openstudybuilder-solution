...
There was an issue in the API which was fixed by this PR (commit `0001bb3f475e`) in scope of release 1.11.2.
For the release 1.11.2 the schema-migration script (ADO PR #203457, archived) fixed the half of broken nodes.
