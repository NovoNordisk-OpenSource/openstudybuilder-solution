...
def move_props_to_has_item_class_rel(db_driver, log):
    ...
    with open(
        "../import_sponsor_data/datafiles/sponsor_library/activity/activity_item_class.csv",
        encoding="utf-8",
    ) as f:
...
def migrate_data_domain_from_activity_instance_class_to_dataset(db_driver, log):
    ...
    with open(
        "../import_sponsor_data/datafiles/sponsor_library/activity/sdtm_mastermodel_3.2-NN15_domain_to_activityInstanceClass.csv",
        encoding="utf-8",
    ) as file:
