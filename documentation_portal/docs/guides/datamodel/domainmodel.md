...
[![Diagram: Domain Model Objective Templates](/images/model/domain_data_model/domain-model-objectives.png)](/images/model/domain_data_model/domain-model-objectives.png)

A detailed description of the domain data model by each API endpoint, or data domain, is available here:

[![Diagram: Domain Model Objective Templates](/images/model/domain_data_model/domain-model.png)](/images/model/domain_data_model/domain-model.png)