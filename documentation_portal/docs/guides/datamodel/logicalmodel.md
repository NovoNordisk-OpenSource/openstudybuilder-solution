...
[![Logical Data Model](/images/model/logical_data_model/logical-model-objectives-endpoints.png)](/images/model/logical_data_model/logical-model-objectives-endpoints.png)
...
[![Logical Data Model](/images/model/logical_data_model/logical-model-controlled-terminologies.png)](/images/model/logical_data_model/logical-model-controlled-terminologies.png)
...
[![Logical Data Model](/images/model/logical_data_model/logical-model-study-definition.png)](/images/model/logical_data_model/logical-model-study-definition.png)

## Study Definition - Study Define Parameters

[![Logical Data Model](/images/model/logical_data_model/logical-model-study-definition-parameters.png)](/images/model/logical_data_model/logical-model-study-definition-parameters.png)


## Study Definition - Study Design

[![Logical Data Model](/images/model/logical_data_model/logical-model-study-definition-design.png)](/images/model/logical_data_model/logical-model-study-definition-design.png)

## Study Definition - Planned Objectives and Planned Endpoints

[![Logical Data Model](/images/model/logical_data_model/logical-model-study-definition-objectives-endpoints.png)](/images/model/logical_data_model/logical-model-study-definition-objectives-endpoints.png)
...
[![Logical Data Model](/images/model/logical_data_model/logical-ddd-model-manage-study.png)](/images/model/logical_data_model/logical-ddd-model-manage-study.png)

## For Study Type (DDD model)

This document describe the Study Type of a Study in the Domain Design Driven approach.

[![Logical Data Model](/images/model/logical_data_model/logical-ddd-model-study-type.png)](/images/model/logical_data_model/logical-ddd-model-study-type.png)
...
[![Logical Data Model](/images/model/logical_data_model/logical-ddd-model-study-objectives-endpoints.png)](/images/model/logical_data_model/logical-ddd-model-study-objectives-endpoints.png)
...
[![Logical Data Model](/images/model/logical_data_model/logical-ddd-model-study-compounds.png)](/images/model/logical_data_model/logical-ddd-model-study-compounds.png)