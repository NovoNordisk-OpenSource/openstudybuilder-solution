...
<a :href="withBase('/images/model/physical_data_model/high-level-neo4j-model.png')" target="_blank" class="tertiary--text footer-links">
    ![Physical Data Model (High Level)](/images/model/physical_data_model/high-level-neo4j-model.png)
</a>
...
To view the physical data model in its entirity, open the [master model file](../../../../../db/model/physical_data_model/neo4j-model.graphml) using a graphml editor.
