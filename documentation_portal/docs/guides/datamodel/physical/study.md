...
![Neo4j Model for Study Versioning](/images/model/physical_data_model/study-model.png)
...
![Study state diagram](/images/model/physical_data_model/studystatediagram.png)
...
![Study state diagram](/images/model/physical_data_model/studycreate.png)
...
![Study state diagram](/images/model/physical_data_model/studyedita.png)
...
![Study state diagram](/images/model/physical_data_model/studyeditb.png)
...
![Study state diagram](/images/model/physical_data_model/studyeditc.png)
...
![Study state diagram](/images/model/physical_data_model/studyrelease.png)
...
![Study state diagram](/images/model/physical_data_model/studylock.png)
...
![Study state diagram](/images/model/physical_data_model/studyunlock.png)
...
![Study state diagram](/images/model/physical_data_model/studydelete.png)
...
![Study state diagram](/images/model/physical_data_model/studyclone.png)
