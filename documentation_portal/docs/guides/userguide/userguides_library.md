...
| Button | Behaviour       |
|:------:|:----------------|
| ![Add](/images/bt_add_blue.png) | Click on the **'Add'** button. This will open a popup with a template form |
...
![Add an Objective Template](/images/library/standards/popup_add_objectivestemplates.png "Fig 3: Add a new Syntax Template")
...
| Button | Behaviour       |
|:------:|:----------------|
| ![Modify](/images/bt_modify_blue.png) | Click on the **'Modify'** button at the end of the row that you want to update. This will open a dedicated popup with the template in modification mode like below |
...
![Modify an Objective Template](/images/library/standards/popup_modify_objectivestemplates.png "Fig 4: Modify a template")

### Validate

| Button | Behaviour       |
|:------:|:----------------|
| ![Set Status to Final](/images/bt_validate_blue.png) | Click on the **'Set the status of this template to Final'** button at the end of the row that you want to validate. |
...
| Button | Behaviour       |
|:------:|:----------------|
| ![New Version](/images/bt_newversion_blue.png) | Click on the **'Create a new version'** button at the end of the row that you want to create a new version of the *Syntax Template*. |
...
| Button | Behaviour       |
|:------:|:----------------|
| ![Export](/images/bt_export_blue.png) | Click on the **'Export'** button (before the Add button) to export the full set of the selected type of templates. |
...
![Audit Trail Example](/images/library/standards/library-standards-template-objective-history.png "Fig 5: Audit Trail Syntax Templates example page")
