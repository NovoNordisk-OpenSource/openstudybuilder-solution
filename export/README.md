# Introduction 
This a small script that exports all defined studies from an OpenStudyBuilder instance. 
...
To export the list of studies without their contents:
...
Build validation is run via
[`.github/workflows/export-build.yml`](../.github/workflows/export-build.yml),
invoked by `pr-required-checks.yml` when a PR touches this component.
