...
export default {
  ...
  copyElementsFromStudy(uid, sourceStudyUid) {
    return repository.post(
      `${resource}/${uid}/study-elements/copy-from-study/${sourceStudyUid}`
    )
  },
  ...
  copyBranchArmsFromStudy(uid, sourceStudyUid) {
    return repository.post(
      `${resource}/${uid}/study-branch-arms/copy-from-study/${sourceStudyUid}`
    )
  },
