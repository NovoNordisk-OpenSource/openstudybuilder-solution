...
export default {
  ...
  getStudyVisitPreview(studyUid, data, options = {}) {
    return repository.post(
      `${resource}/${studyUid}/study-visits/preview`,
      data,
      options
    )
  },
  ...
  studyEpochsBatchActions(studyUid, data) {
    return repository.post(`${resource}/${studyUid}/study-epochs/batch`, data)
  },
  studyEpochsBatchPreview(studyUid, data) {
    return repository.post(
      `${resource}/${studyUid}/study-epochs/batch/preview`,
      data
    )
  },
