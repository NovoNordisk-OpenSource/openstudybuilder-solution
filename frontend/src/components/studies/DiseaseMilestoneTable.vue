<template>
  <div>
    <NNTable
      ref="table"
      table-id="studies-disease-milestones-table"
      :headers="headers"
      ...
      :history-config="{
        dataFetcher: fetchDiseaseMilestonesHistory,
        title: $t('DiseaseMilestoneTable.global_history_title'),
      }"
      :export-config="{
        objectLabel: 'DiseaseMilestones',
