<template>
  <NNTable
    ref="tableRef"
    table-id="studies-eligibility-criteria-table"
    :headers="headers"
    :items="criteria"
    ...
    :history-config="{
      dataFetcher: fetchAllCriteriaHistory,
      htmlFields: historyHtmlFields,
      title: $t('EligibilityCriteriaTable.global_history_title'),
    }"
    :export-config="{
      dataUrlParams: exportDataUrlParams,
      objectLabel: 'StudyCriteria',
