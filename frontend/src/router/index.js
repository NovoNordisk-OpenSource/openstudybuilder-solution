...
const routes = [
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            component: () =>
              import('../views/library/TrialParameterDetails.vue'),
            meta: {
              authRequired: true,
            },
          },
      ...
      {
        path: 'ct/:library_name/:tab?',
        name: 'CtLibrary',
        component: () => import('../views/library/CtLibraryPage.vue'),
        meta: {
          authRequired: true,
        },
      },
      ...
      {
        path: 'trial_summary_parameters',
        name: 'TrialSummaryParameters',
        component: () => import('../views/library/TrialSummaryParameters.vue'),
        meta: {
          authRequired: true,
        },
      },
      ...
      {
        path: 'interventions/compounds/:id',
      ...
      {
        path: 'interventions/pharmaceutical_products/:id',
...
router.beforeEach(async (to, from, next) => {
  ...
  // Feature flags require read permissions when OAuth is enabled
  if (!$config.OAUTH_ENABLED || authStore.userInfo) {
