...
from src.tests.cdisc_ct.test_pipeline import Package, Import
...
def get_expected_imports(effective_date, author_id):
    ...
    package1 = Package(
        uid=f"{effective_date}_TEST-CASE 5 CT",
        catalogue_name="TEST-CASE 5 CT",
        registration_status="Final",
        name="TEST-CASE 5 CT 2020-01-01",
        label="Test-Case 5 Controlled Terminology Package 1 Effective 2020-01-01",
        description="Test-Case 5: There is a codelist with the name 'Codelist 001 Name' and another codelist with the name 'Codelist 001'. -> import code and name submission values.",
        source="Test source",
