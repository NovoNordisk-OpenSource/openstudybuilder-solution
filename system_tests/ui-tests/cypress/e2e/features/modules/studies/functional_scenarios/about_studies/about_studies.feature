...
Feature: Studies - About Studies
    ...
    #hidden feature
    #Scenario: [Overview][Description] User must be able to see the description of the Process Overview area
    ...
    Scenario: [Overview][Description] User must be able to see the description of the Manage Studies area
        Given The '/studies' page is opened
    ...
    Scenario: [Overview][Description] User must be able to see the description of the Define Study area
        Given The '/studies' page is opened
    ...
    Scenario: [Overview][Description] User must be able to see the description of the View Specifications area
        Given The '/studies' page is opened
    ...
    Scenario: [Overview][Description] User must be able to see the description of the View Listings area
        Given The '/studies' page is opened
