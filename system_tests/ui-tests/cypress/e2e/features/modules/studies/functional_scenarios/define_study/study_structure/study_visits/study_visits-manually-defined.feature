...
Feature: Studies - Define Study - Study Structure - Study Visits
   ...
   Scenario Outline: Visit name, short name, number and unique number for manually defined study visits must be unique
      ...
      Then The pop up displays "Value \"test value\" in field "<study visit field>" is not unique for the study"
   ...
   Scenario Outline: Visit name, short name, number and unique number for non-manually defined study visits must be unique
      ...
      Then The pop up displays "Value \"test value\" in field "<study visit field>" is not unique for the study as a manually defined value exist. Change the manually defined value before this visit can be defined."
      And the study visit values are not saved
      And The form is not closed
      Examples:
         | study visit field   |
   ...
   Scenario: Visit number for manually defined study visits must be in cronological order by study visit timing
      ...
      Then The pop up displays "Value \"test visit number\" in field visit number is not defined in cronological order by study visit timing"
      And the study visit values are not saved
      And The form is not closed
   ...
   Scenario: Unique visit number for manually defined study visits must be in cronological order by study visit timing
      ...
      Then The pop up displays "Value \"test unique visit number\" in field unique visit number is not defined in cronological order by study visit timing"
      And the study visit values are not saved
      And The form is not closed
